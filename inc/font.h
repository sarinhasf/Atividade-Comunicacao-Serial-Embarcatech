...
// Aqui representa uma bitmap, ou melhor, uma matriz de bits que representa os caracteres,
// Cada caractere é representado por 8 bytes, onde cada byte contém 8 bits que indicam quais 
// pixels devem ser ativados (1) ou desativados (0).

//Assim esses caracteres são denhados na grande de 8x8 pixels
